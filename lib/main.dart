...
void main()=> runApp(ThirukuralApp());
...
@override
  Widget build(BuildContext context){
    ...
    return Scaffold(
      appBar: AppBar(title:Text("திருக்குறள்",textDirection: TextDirection.ltr,style: TextStyle(fontWeight:FontWeight.bold,color: Colors.brown,fontSize: 18.0),
      ),
      centerTitle: true,
...
விளக்கம்:
அறக்கடலாக விளங்கும் கடவுளின் திருவடிகளைப்பொருந்தி நினைக்கின்றவர் அல்லாமல், மற்றவர் பொருளும் இன்பமுமாகிய மற்றகடல்களைக் கடக்க முடியாது"""
);
}
case 9:
{
